...
def generate_schema() -> bool:
    ...
    if not database_url:
        print("⚠️  DATABASE_URL not set, skipping schema generation")
        return False
...
def main() -> int:
    ...
    """
    print("🔄 Updating AI context files...\n")
    ...
    if all(results):
        ...
        print("⚠️  AI context partially updated (some files skipped)")
        return 0
    else:
        print("❌ AI context update failed")
        return 1
